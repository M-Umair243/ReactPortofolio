                        ...
                        <div className="right box-shadow">
                            <form onSubmit={formSubmit}>
                                <div className="f-flex">
                                    ...
                                    <div className="input">
                                        <span>SUBJECT</span>
                                        <input type="subject" name='subject' value={data.subject} onChange={inputEvent} />
                                    </div>
                                    <div className="input">
                                        <span>MESSAGE</span>
                                        <textarea cols="30" rows="10" name='message' value={data.message} onChange={inputEvent}></textarea>
                                    </div>
                                    <button className='btn-shadow'>SEND MESSAGE <i className='fa fa-long-arrow-down'></i></button>
